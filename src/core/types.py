...
class TaxRuleType(str, Enum):
    ...
    ROT_DEDUCTION = "ROT_ARBETSKOSTNAD_30"
    GRON_TEKNIK = "GRON_TEKNIK_SKATTEREDUKTION"
    ...
    FOU_DEDUCTION = "FOU_FORSKNINGSAVDRAG"
    K10_DIVIDEND_OPTIMAL = "K10_UTDELNING_3_12"
    FRISKVARD_BENEFIT = "SKATTEFRI_FRISKVARD"
    EXPANSIONSFOND = "EXPANSIONSFOND_20_6"
    REPRESENTATION_DEDUCTIBLE = "SKATTEFRI_REPRESENTATION"
